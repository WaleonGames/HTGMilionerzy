...
saveButton.addEventListener("click",async()=>{
  ...
  try{
    ...
    window.millionaireDesign?.apply({
      theme:
        savedSettings.appearance?.theme??"light",

      accentColor:
        savedSettings.appearance?.accentColor??"#356df3"
    });
...
resetButton.addEventListener("click",async()=>{
  ...
  try{
    ...
    window.millionaireDesign?.apply({
      ...
      accentColor:
        settings.appearance?.accentColor??"#356df3"
    });
