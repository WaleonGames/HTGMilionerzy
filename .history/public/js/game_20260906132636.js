...
function selectAndCheckAnswer(
  ...
  const selectedScreenAnswer=
    getScreenAnswer(selected);

  if(selectedScreenAnswer){
    selectedScreenAnswer.classList.add(
      "selected"
    );
  }
...
function handleCorrectAnswer(
  ...
  const correctScreenAnswer=
    getScreenAnswer(
      correctAnswer
    );

  if(correctScreenAnswer){
    correctScreenAnswer.classList.remove(
      "selected"
    );

    correctScreenAnswer.classList.add(
      "correct"
    );
  }
...
function handleWrongAnswer(
  ...
  if(selectedScreenAnswer){
    selectedScreenAnswer.classList.remove(
      "selected"
    );
